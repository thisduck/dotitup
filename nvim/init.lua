...
vim.cmd [[nnoremap <Leader>is <cmd>source ~/.config/nvim/init.lua <bar> PackerSync<CR>]]
vim.cmd [[nnoremap <Leader>ic <cmd>source ~/.config/nvim/init.lua <bar> PackerInstall <bar> PackerCompile <bar> PackerSnapshot snap.json<CR> ]]
  ...
  function()
    ...
    use {
      ...
      config = function()
        ...
        -- vim.cmd [[nnoremap <Leader>/ :lua require('telescope.builtin').grep_string({ search = vim.fn.input("> ", "", "tag")})<CR>]]
        -- vim.cmd [[nnoremap <Leader>/ :lua require('telescope.builtin').grep_string({ search = ""})<LEFT><LEFT><LEFT>]]
        vim.cmd [[nnoremap <Leader>/ :Search ]]
        vim.cmd [[nnoremap <Leader><tab> <cmd>lua require('telescope.builtin').tags()<cr>]]
        vim.cmd [[nnoremap <Leader><tab><tab> <cmd>lua require('telescope.builtin').keymaps()<cr>]]
