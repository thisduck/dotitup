...
" Version: 0.0.1
" Taken from: https://raw.githubusercontent.com/thcipriani/dotfiles/master/vim/autoload/literatevimrc.vim
" A change was made so that ``` blocks need to start with ```vim
...
function! s:parse_codeblocks(file) abort
    ...
    for line in readfile(a:file)
        ...
        let end_block = s:ends_codeblock(line)
        ...
        if code_block_open ==# 1 && end_block
            let code_block_open = 0
            continue
        endif
